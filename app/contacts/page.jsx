...
export default function Contacts() {
    ...
    return (
        <main className="container py-20">
            <h1 className="font-extralight text-5xl md:text-7xl text-center md:text-left uppercase text-green mb-20">Mari Stretching</h1>
            ...
            <form className="flex flex-col pt-20">
                ...
                <div className="grid grid-cols-2 grid-rows-3 grid-flow-col gap-x-16 gap-y-8 mb-20">
                ...
                <button className="font-semibold md:text-4xl uppercase text-white bg-whitegreen rounded-3xl px-[152px] py-10 self-end hover:bg-pink">Отправить</button>
            </form>
        </main>
    );
}